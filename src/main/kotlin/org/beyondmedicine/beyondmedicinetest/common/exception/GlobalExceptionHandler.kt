...
class GlobalExceptionHandler {
    ...
    fun handleInternalServerErrorException(e: AccessCodeRetryFailException): ApiResponse<Void> {
        return ApiResponse.internalServerError(e.message?:"")
    }

    @ExceptionHandler(UserAccessCodeNotActivatedException::class)
    @ResponseStatus(HttpStatus.FORBIDDEN)
    fun handleForbiddenException(e: UserAccessCodeNotActivatedException): ApiResponse<Void> {
    ...
    fun handleConflictException(e: AccessCodeAlreadyActivatedException): ApiResponse<Void> {
        return ApiResponse.conflict(e.message?:"")
    }

    @ExceptionHandler(IllegalArgumentException::class, BindException::class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    fun handleBadRequestException(e: IllegalArgumentException): ApiResponse<Void> {
        return ApiResponse.badRequest(e.message?:"")
    }

    @ExceptionHandler(NoSuchElementException::class)
    @ResponseStatus(HttpStatus.NOT_FOUND)
    fun handleNotFoundException(e: NoSuchElementException): ApiResponse<Void> {
